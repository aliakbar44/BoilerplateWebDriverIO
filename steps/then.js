...
import DeleteInst from '../support/MyActions/DeleteInst';
import EditInst from '../support/MyActions/EditInst';
...
Then(
    /^I click on delete instruction$/,
    DeleteInst
);

Then(
    /^I click edit instruction$/,
    EditInst
);
